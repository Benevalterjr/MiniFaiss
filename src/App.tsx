      ...
      <div className="max-w-[1400px] mx-auto px-6 py-8 grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <aside className="lg:col-span-3 space-y-8">
          ...
          <section className="glass-card p-5 space-y-4">
            ...
            {/* Gemini Key */}
            <div className="space-y-1">
              <label className="text-[9px] text-slate-500 uppercase tracking-wider font-bold">Google Gemini</label>
              <div className="relative">
                ...
                />
                {geminiApiKey && (
                  <button onClick={() => setGeminiApiKey("")} className="absolute right-2 top-1/2 -translate-y-1/2 text-slate-600 hover:text-red-400 transition-colors" title="Limpar">
            ...
            {/* Groq Key */}
            <div className="space-y-1">
              <label className="text-[9px] text-slate-500 uppercase tracking-wider font-bold">Groq (Fallback)</label>
              <div className="relative">
                <input 
                  type="password"
                  value={groqApiKey}
                ...
                />
                {groqApiKey && (
                  <button onClick={() => setGroqApiKey("")} className="absolute right-2 top-1/2 -translate-y-1/2 text-slate-600 hover:text-red-400 transition-colors" title="Limpar">
                    <X className="w-3.5 h-3.5" />
                  </button>
                )}
              </div>
            ...
            <div className="flex items-start gap-2 p-2.5 bg-slate-900/30 rounded-lg border border-slate-800/50">
              ...
              <p className="text-[9px] text-slate-500 leading-relaxed">
                <strong className="text-slate-400">BYOK</strong> — Chaves em <code className="text-brand-400/80">sessionStorage</code>. Cadeia: Gemini 2.5 → 2.0 → Groq Llama 3.3 70B.
              </p>
            </div>
          </section>
        </aside>
